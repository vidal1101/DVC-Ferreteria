...
public class CajaControlador implements PropertyChangeListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == ventanaVentas.getBtnFacturar()) {
            ...
            if (file != -1) {
                ...
                if (cantidad <= stock) {
                    ...
                    producto.setPrecioProd(Double.valueOf(mostrador.getTblMostrar().getValueAt(file, 4).toString()));
    ...
    private void facturar() {
        ...
        ClassFactura facturaNueva = new ClassFactura(arraysDetalles,
                fechaSQL,
                cliente,
                trabajador,
                Double.parseDouble(ventanaVentas.getTxtTotalPagar().getText()),
