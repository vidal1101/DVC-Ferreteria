 ...
 */
public class CajaControladorVidal implements ActionListener, KeyListener, WindowListener, MouseEvent {
        ...
        if (e.getSource() == ventas.getBtnCliente()) {
            ...
            if (file != -1) {
                ...
                if (cantidad <= stock) {
                    ...
                    JOptionPane.showMessageDialog(null, "la cantidad no coincide ", "ERROR DE DATOS", JOptionPane.WARNING_MESSAGE);

                }

//                if (!revisarid(detaFactura.getIdProd())) {
//                }
                //"ID", "Proveedor", "Categoria", "Nombre Prod ", "Precio", "Descuento", "Venta por",
